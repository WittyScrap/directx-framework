...
Graphics2::Graphics2() : Framework(800, 500)
{
	...
	_eyePosition = XMFLOAT4(0.0f, 0.0f, -10.0f, 0.0f);
...
{
	_rotationAngle += 1.0f;
	// Update our world transformations
	XMStoreFloat4x4(&_worldTransformation1, XMMatrixRotationAxis(XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), _rotationAngle * 0.5f * XM_PI / 180.0f));
	XMStoreFloat4x4(&_worldTransformation2, XMMatrixRotationAxis(XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), _rotationAngle * XM_PI / 180.0f) * XMMatrixTranslation(2.0f, 0, -2.5f));
}
...
void Graphics2::Render()
{
	...
	XMMATRIX completeTransformation = XMLoadFloat4x4(&_worldTransformation1) * XMLoadFloat4x4(&_viewTransformation) * XMLoadFloat4x4(&_projectionTransformation);
	...
	// Draw the second cube.  The only thing we need to update is the
	// transformations in the constant buffer
	completeTransformation = XMLoadFloat4x4(&_worldTransformation2) * XMLoadFloat4x4(&_viewTransformation) * XMLoadFloat4x4(&_projectionTransformation);
	cBuffer.CompleteTransformation = completeTransformation;
...
void Graphics2::BuildGeometryBuffers()
{
...
void Graphics2::BuildVertexLayout()
{
...
void Graphics2::BuildConstantBuffer()
{
