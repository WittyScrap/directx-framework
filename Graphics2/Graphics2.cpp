...
void Graphics2::Update()
{
	...
	XMStoreFloat4x4(&_worldTransformation2, XMMatrixTranslation(2.0f, 0, -2.5f) * XMMatrixRotationAxis(XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), _rotationAngle * XM_PI / 180.0f));
}
